          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="blog__details__hero__text">
                <h2>{{$route.query.data.name}}</h2>
                <ul>
                  <li>{{$route.query.data.category}}</li>
                  <li>Rerelease: {{
$route.query.data.year_release}}</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-8 col-md-4 blog__details__content">
              <div class="blog__details__text">
                <div class="blog__details__text__img">
                  <img :src="$route.query.data.image_url" alt="" />
                </div>
                <p>
                 {{$route.query.data.review}}
                </p>
              </div>
            </div>
          </div>
